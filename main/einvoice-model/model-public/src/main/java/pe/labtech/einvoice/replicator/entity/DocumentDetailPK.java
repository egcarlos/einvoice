...
public class DocumentDetailPK implements Serializable {
    ...
    public String toString() {
        return "DocumentDetailPK{" + "tipoDocumentoEmisor=" + tipoDocumentoEmisor + ", numeroDocumentoEmisor=" + numeroDocumentoEmisor + ", tipoDocumento=" + tipoDocumento + ", serieNumero=" + serieNumero + ", numeroOrdenItem=" + numeroOrdenItem + '}';
    }
