 ...
 * @author carloseg
 */
public class InvoiceLineBuilder extends BaseBuilder<InvoiceLineType> implements Builder<InvoiceLineType> {

    private CurrencyCodeContentType currency;

    public InvoiceLineBuilder() {
        super(InvoiceLineType::new);
    }

    @Override
    public InvoiceLineBuilder init() {
        return (InvoiceLineBuilder) super.init();
    }

    @Override
    public InvoiceLineType compile() {
        return reference;
    }
     ...
     * @return
     */
    public InvoiceLineBuilder init(String lineNumber, BigDecimal quantity, String unit, String code, String description, String currency, BigDecimal unitPrice, String alternateUnitPriceCode, BigDecimal alternateUnitPrice, BigDecimal totalAmount) {
     ...
     * @return
     */
    public InvoiceLineBuilder init(String lineNumber, BigDecimal quantity, String unit, String code, String description, CurrencyCodeContentType currency, BigDecimal unitPrice, String alternateUnitPriceCode, BigDecimal alternateUnitPrice, BigDecimal totalAmount) {
        this.currency = currency;
        reference = init(InvoiceLineType::new, i -> {
            i.setID(id(lineNumber));
            i.setInvoicedQuantity(quantity(InvoicedQuantityType::new, unit, quantity));
    ...
    private InvoiceLineBuilder addDescription(String description) {
        if (description != null) {
    ...
    public InvoiceLineBuilder addAdditionalItemProperty(String code, String value) {
    ...
    public <T> InvoiceLineBuilder addItemAttribute(BiConsumer<ItemType, T> consumer, T value) {
    ...
    public InvoiceLineBuilder addAlternativeConditionPrice(String PriceTypeCode, BigDecimal price) {
    ...
    public InvoiceLineBuilder addAllowance(BigDecimal amount) {
        return addAllowanceCharge(false, amount);
    }

    public InvoiceLineBuilder addCharge(BigDecimal amount) {
        return addAllowanceCharge(true, amount);
    }

    public InvoiceLineBuilder addAllowanceCharge(boolean chargeIndicator, BigDecimal amount) {
        if (amount != null) {
