...
import static pe.labtech.ubl.model.Namespaces.VD;
...
public class VoidedDocuments {
    ...
    private List<VoidedDocumentsLine> VoidedDocumentsLine;

    {
        this.VoidedDocumentsLine = new LinkedList<>();
    }
    ...
    public List<VoidedDocumentsLine> getVoidedDocumentsLine() {
        return VoidedDocumentsLine;
    }

    public void setVoidedDocumentsLine(List<VoidedDocumentsLine> VoidedDocumentsLine) {
