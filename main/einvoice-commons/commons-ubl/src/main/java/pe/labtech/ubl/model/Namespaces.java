...
public class Namespaces {
    ...
    public static final String NS10 = "urn:sunat:names:specification:ubl:peru:schema:xsd:SummaryDocuments-1";
    public static final String NS11 = "urn:sunat:names:specification:ubl:peru:schema:xsd:VoidedDocuments-1";
    public static final String NS6 = "urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2";
    public static final String NS7 = "urn:oasis:names:specification:ubl:schema:xsd:DebitNote-2";
