...
/**
* Clase DebitNoteLineBuilder.
*
* @author Labtech S.R.L. (info@labtech.pe)
*/

public class DebitNoteLineBuilder implements Builder<DebitNoteLine> {

    private DebitNoteLine item;

    @Override
    public DebitNoteLine compile() {
        return item;
    }
    ...
    public DebitNoteLineBuilder init(
        ...
        DebitNoteLineBuilder ilb = this;
        DebitNoteLine il = new DebitNoteLine();
        //id de la linea
        il.setID(lineNumber);
        //cantidad de items
        il.setDebitedQuantity(new Quantity(unit, quantity));
    ...
    public DebitNoteLineBuilder addAlternativeConditionPrice(String PriceTypeCode, String currencyID, BigDecimal price) {
