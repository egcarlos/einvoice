...
public class DocumentHeaderPK implements Serializable {
    ...
    public String toString() {
        return "DocumentHeaderPK{" + "tipoDocumentoEmisor=" + tipoDocumentoEmisor + ", numeroDocumentoEmisor=" + numeroDocumentoEmisor + ", tipoDocumento=" + tipoDocumento + ", serieNumero=" + serieNumero + '}';
    }
