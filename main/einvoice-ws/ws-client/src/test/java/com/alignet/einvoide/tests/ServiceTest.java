...
public class ServiceTest {
    ...
    @Test
    public void summary() throws ParseException {
        EBizGenericInvokerImplService service = new EBizGenericInvokerImplService();
        EBizGenericInvoker port = service.getEBizGenericInvokerImplPort();
    ...
    public void sign() {
        String command = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>"
                ...
                + "        <serieNumero>BLT1-00000004</serieNumero>"
                ...
                + "        <numeroDocumentoAdquiriente>42855502</numeroDocumentoAdquiriente>"
                + "        <razonSocialAdquiriente>Carlos Echeverria</razonSocialAdquiriente>"
                + "        <lugarDestino>MZ B LT 15 AV EL PORVENIR SAN JUAN LURIGANCHO</lugarDestino>"
                + "        <correoAdquiriente>carlos.echeverria@labtech.pe</correoAdquiriente>"
